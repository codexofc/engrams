...
description: Shippers can set a maximum price per load, bids above it are hidden from the shipper but the carrier is told the cap exists not its value, and a cap under 85 % of the suggestion triggers a warning to the shipper at posting
type: project
status: active
verified: 2026-05-14
---
